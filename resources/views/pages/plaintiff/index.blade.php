...
@section('title', 'Daftar Semua Penggugat')
                                    ...
                                    <ul class="users-item-dropdown dropdown">
                                        <li>
                                            {{-- <button class="btn btn-sm btn-light btn-edit" data-toggle="modal"
                                                data-target="#penggugat"
                                                data-url="{{ route('plaintiff.update', $submission->id) }}"
                                                data-name="{{ $submission->user->name }}"
                                                data-email="{{ $submission->user->email }}"
                                                data-nik="{{ $submission->nik }}"
                                                data-address="{{ $submission->address }}"
                                                data-place_of_birth="{{ $submission->place_of_birth }}"
                                                data-date_of_birth="{{ $submission->date_of_birth }}"
                                                data-gender="{{ $submission->gender }}"
                                                data-phone="{{ $submission->phone }}">Edit</button> --}}
                                        </li>
                                    </ul>
                                </span>
                            </td>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-label-wrapper">
                            ...
                            <input type="text" name="phone" id="phone" value="{{ old('phone') }}" class="form-input"
                                placeholder="Tulis nomor telpon penggugat disini">
                        </div>
                    </div>
