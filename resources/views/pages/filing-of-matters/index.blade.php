    ...
    <div class="card border-0 rounded">
        <div class="card-body">
            @if (Auth::user()->role === 'people')
                <h4>Pengajuan Anda</h6>
                @else
                    <h4>Pengajuan Penggugat</h4>
            @endif
            <br>
                                    ...
                                    <div class="modal-body border-0">
                                        ...
                                        <div class="form-label-wrapper">
                                            ...
                                            <textarea type="text" name="name" id="name"
                                                class="form-input">{{ $submission->user->people->address }}</textarea>
                                        </div>
                                        <div class="form-label-wrapper">
            ...
            <h4>Menu Layanan Perkara</h6>
                <div class="row justify-content-center">
                    @foreach ($filingOfMatters as $filingOfMatter)
                        <div class="col-4 col-md-2 text-danger text-center text-dark">
                            <a href="javascrypt:;" data-toggle="modal" data-target="#modelId-{{ $filingOfMatter->id }}">
                                <img src="{{ url('storage') . '/' . $filingOfMatter->icon }}" class="img-fluid"
                                    alt="Folder">
                                <small><strong>{{ $filingOfMatter->name }}</strong></small>
                            </a>
                        </div>
