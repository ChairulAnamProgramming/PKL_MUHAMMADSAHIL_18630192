                ...
                <form action="{{route('user.update',Auth::user()->id)}}" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="gender">
                            ...
                            <option {{Auth::user()->people->gender=='male'?'selected':''}} value="male">Laki-laki
                            </option>
                            <option {{Auth::user()->people->gender=='female'?'selected':''}} value="female">Perempuan
                            </option>
                        </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <img src="{{url('storage').'/'.Auth::user()->people->ktp}}" class="img-fluid" width="" alt="">
                        <input type="file" name="ktp" id="ktp" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="kk" class="d-block">Scane KK</label>
                        <img src="{{url('storage').'/'.Auth::user()->people->kk}}" class="img-fluid" width="" alt="">
