...
@section('title', 'Data Semua Hakim')
@section('button')
    <button type="button" class="btn btn-primary btn-round btn-sm" data-toggle="modal" data-target="#hakim">
...
@section('content')
                        ...
                        <tbody>
                            @foreach ($employees as $employee)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <form action="{{ route('judge.destroy', $employee->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
    ...
    <!-- Modal -->
    <div class="modal fade" id="hakim" tabindex="-1" aria-labelledby="hakimLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="form" action="{{ route('judge.store') }}" method="POST">
                    @csrf
                    <div id="patch"></div>
